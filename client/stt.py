...
class PocketSphinxJasperSTT(AbstractSTTEngine):
    SLUG = 'sphinx-jasper'
    VOCABULARY_TYPE = vocabcompiler.PocketsphinxVocabulary
    
    def __init__(self, vocabulary=None, hmm_dir=None, dic=None):
        ...
        self._decoder = ps.Decoder(hmm=hmm_dir, logfn="decoder.log",
        ...
        if os.path.exists(profile_path):
            with open(profile_path, 'r') as f:
                ...
                try:
                    ...
                    config['lm'] = profile['pocketsphinx']['language_model']
                    config['dic'] = profile['pocketsphinx']['dictionary']
                except KeyError:
                    pass
...
class PocketSphinxSTT(AbstractSTTEngine):
    ...
    def __init__(self, vocabulary=None, hmm_dir=None, lm=None, dic=None):
